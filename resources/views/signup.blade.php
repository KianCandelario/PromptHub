...
<body>
    <main class="relative w-screen h-screen">
        <div class="w-full h-full bg-gradient-to-br from-[#191E29] to-[#696E79] flex justify-center items-center">
            <div class="w-[22%] h-[78%] bg-[#132D46] rounded-2xl p-7 shadow-xl">
                ...
                <form class="w-full flex flex-col justify-center items-center" action="" method="">
                    ...
                    <input class="w-[45%] h-9 font-bold bg-[#01C38D] font-poppins text-xs cursor-pointer mt-4 rounded-md text-[#F0F5F9] hover:bg-[#FFFFFF] hover:text-[#191E29] hover:scale-100 hover:translate-y-1 transition duration-300" type="submit" value="SIGN UP">
                </form>
            </div>
        </div>
    </main>
